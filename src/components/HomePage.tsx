    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        <div className="inline-flex items-center gap-3 mb-4">
          ...
          <h1 className="text-4xl font-bold text-foreground">Welcome to Suraksha Kavach</h1>
        </div>
        ...
        {quickActions.map((action) => {
          ...
          return (
            <button
              ...
              className={`p-6 rounded-lg border border-subtle-border transition-all hover:shadow-lg hover:scale-105 ${action.color} ${
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-card border border-subtle-border rounded-lg p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3 p-3 bg-subtle-hover/50 rounded-lg">
        ...
        <div className="bg-card border border-subtle-border rounded-lg p-6">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-success/5 border border-success/20 rounded-lg">
              <h4 className="font-medium text-success mb-1">Tip of the Day</h4>
            ...
            <div className="p-4 bg-info/5 border border-info/20 rounded-lg">
              <h4 className="font-medium text-info mb-1">Did You Know?</h4>
              <p className="text-sm text-foreground">
